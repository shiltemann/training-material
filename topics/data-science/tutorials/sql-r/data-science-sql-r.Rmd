...
:::{.question}
<div id="question-filling-a-table-vs-printing-values" class="box-title" aria-label="question box: Filling a Table vs. Printing Values">❓<span class="visually-hidden"></span> Question: Filling a Table vs. Printing Values</div>
...
:::{.question}
<div id="question-filtering-in-sql-vs-filtering-in-r" class="box-title" aria-label="question box: Filtering in SQL vs. Filtering in R">❓<span class="visually-hidden"></span> Question: Filtering in SQL vs. Filtering in R</div>
